...
import telran.spring.person.dao.PersonRepository;
import telran.spring.person.dto.AddressDto;
import telran.spring.person.dto.ChildDto;
import telran.spring.person.dto.CityPopulationDto;
import telran.spring.person.dto.EmployeeDto;
import telran.spring.person.dto.PersonDto;
import telran.spring.person.dto.exceptions.PersonNotFoundException;
import telran.spring.person.dto.exceptions.UnknownPersonTypeException;
import telran.spring.person.model.*;

@Service
@RequiredArgsConstructor
public class PersonServiceImpl implements PersonService, CommandLineRunner {

	private static final String MODEL_PACKAGE = "telran.spring.person.model.";
	private static final String DTO_SUFFIX = "Dto";
	private static final String DTO_PACKAGE = "telran.spring.person.dto.";

	final PersonRepository personRepository;
	final ModelMapper modelMapper;

	@Override
	@Transactional // Соединение с базой остается открытым во время выполнения метода и закрывается после return
